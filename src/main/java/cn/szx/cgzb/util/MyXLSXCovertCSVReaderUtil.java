 ...
 * @author 山人 
 */  
public class MyXLSXCovertCSVReaderUtil {
	 ...
	 */
	public MyXLSXCovertCSVReaderUtil(OPCPackage pkg, PrintStream output, String sheetName, int minColumns) {
	 ...
	 * @throws IOException
	 */
	private static List<String[]> readerExcel(String path, String sheetName, int minColumns) throws IOException, OpenXML4JException, ParserConfigurationException, SAXException {
		OPCPackage p = OPCPackage.open(path, PackageAccess.READ);
		MyXLSXCovertCSVReaderUtil xlsx2csv = new MyXLSXCovertCSVReaderUtil(p, System.out, sheetName, minColumns);
	...
	public static void main(String[] args) throws Exception {
		List<String[]> list = MyXLSXCovertCSVReaderUtil.readerExcel("E:\\项目文档\\采购绿色通道20150415\\上海市\\最新配置文档\\交接文档（合同-专业-人员）-2015年12月15日.xlsx", "37", 170000);
